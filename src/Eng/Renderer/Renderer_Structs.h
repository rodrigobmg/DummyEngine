...
struct MainDrawBatch {  // NOLINT
    ...
    static const uint64_t BitVege       = (1ull << 59u);
    static const uint64_t BitsProgId    = (0b11111111ull << 55u);
    static const uint64_t BitsMatId     = (0b11111111111111ull << 41u);
    static const uint64_t BitsCamDist   = (0b11111111ull << 33u);
    static const uint64_t FlagBits      = (0b11111ull << 59u);
